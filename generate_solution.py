...
def generate_initial_solution(enclos_sizes, enclos_weights):
    n = len(enclos_sizes)
    size = math.ceil(math.sqrt(n))
    solution = [[]] * n
    enclos_number = 0
...
# solution = local_search(solution, enclos_weights, subset, k, enclos_sizes, 10)

# output_file_path = "sol_n200_m150_V-68542542.txt"
